function switchtask(subjid, tasktype)
  ...
  tasktypes = {'green', 'red', 'longmix1', 'longmix2'};

  %% INFO
  cprintf('green', 'Welcome to the switch task\n');
  ...
  cprintf('green', '\t    green   ');
          fprintf('- congruent "pure" block (XX secs). like: 1 0 0\n');
  cprintf('red'  , '\t    red     ');
          fprintf('- interfere "pure" block (XX secs). like: 3 2 2\n');
  cprintf('magenta', '\t    longmix1');
         fprintf('- mixed block (XX secs)\n');
